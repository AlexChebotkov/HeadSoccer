...
public class Panel extends JPanel implements ActionListener {
    ...
    private final GameLogic gameLogic;//запоминает логику игры , от куда получает координаты игроков и мяча
    private int counts = 0;
    private long lt;
    private boolean isMenu = true;


    private final Image rightGoal = new ImageIcon("/Users/alexandr/IdeaProjects/untitled7/src/right_goal.png").getImage();
    private final Image leftGoal = new ImageIcon("/Users/alexandr/IdeaProjects/untitled7/src/left_goal.png").getImage();
    private final Image ballImage = new ImageIcon("/Users/alexandr/IdeaProjects/untitled7/src/ball.png").getImage();
    private final Image grass = new ImageIcon("/Users/alexandr/IdeaProjects/untitled7/src/grass.png").getImage();
    private final Image leftHead = new ImageIcon("/Users/alexandr/IdeaProjects/untitled7/src/left_head.png").getImage();
    private final Image rightHead = new ImageIcon("/Users/alexandr/IdeaProjects/untitled7/src/right_head.png").getImage();
    private final Image leftBody = new ImageIcon("/Users/alexandr/IdeaProjects/untitled7/src/left_body.png").getImage();
    private final Image rightBody = new ImageIcon("/Users/alexandr/IdeaProjects/untitled7/src/right_body.png").getImage();
    private final Image border = new ImageIcon("/Users/alexandr/IdeaProjects/untitled7/src/border.jpeg").getImage();
    private final Image menuBg = new ImageIcon("/Users/alexandr/IdeaProjects/untitled7/src/menubg.jpg").getImage();
    ...
    public Panel(GameLogic gameLogic, int fps) {
        ...
        add(exitB);
        Timer timer = new Timer(1000 / (fps * gameLogic.getCountsPerFrame()), this);//создает таймер , который 60 раз в секунду вызывает actionperformed
        timer.start();
        lt = System.nanoTime();
    }
    ...
    public void paintComponent(Graphics graphics) {
        ...
        Graphics2D g = (Graphics2D) graphics;// с помощью нее рисуем
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (counts == gameLogic.getCountsPerFrame()) {
            counts = 0;
            repaint();//сначала удаляет , потом рисует все занаво с помощью paintcomponent
        }
    }
}
